               ...
               <div class="div1">
                 <table width="326" border="0" cellpadding="0" cellspacing="0" class="table" align="center">
                    <tbody>
                     ...
                     <!-- codigo para que jale la informacion: descomentar -->
                     ...
                     <!-- <tr>
                       <td height="136" colspan="3" align="center" class="nombre_g">
                        ...
                        <span id="lbl_Indentificador" class="identificador">Identificador: 45632145</span>
                       </td>
                     </tr> -->
                     <tr>
                       <td colspan="3">
                     ...
                     <tr>
                       <td colspan="3" align="center">
                        <!-- CODE DE EJM QR -->
                        <!-- <img width="120" class="code_qr" src="http://enc-ticketing.org/tkt/caii/img-gafete/qr.png" /> -->
                     ...
                     <tr>
                       <td colspan="3" class="full_width" valign="bottom">
                        <!-- img footer -->
                          <img src="http://enc-ticketing.org/comunicaciones/enconocimiento/jornada_regidores/footer2.png" alt="" style="width: 11.4cm; padding-top: 2px; padding-bottom: 2px;"/>
                       </td>
                     </tr>
                     <tr>
                       <td colspan="3"><br />
