...
<div class="container">
            ...
            <div class="content">
                ...
                <table border="1">
                    ...
                    <tr bgcolor="#c0c0c0">
                        ...
                        <td colspan="2"
                            style="text-align:center;margin-left:auto;margin-right:auto;"><strong>DOCUMENTO
                    ...
                    <tr>
                        <td colspan="3">{{$datos->ape_paterno}}</td>
                        <td colspan="3">{{$datos->ape_materno}}</td>
                        <td colspan="3">{{$datos->nombre}}</td>
                        <td>{{$datos->tipo_doc}}</td>
                        <td>{{$datos->documento_iden}}</td>
                    </tr>
                    <tr bgcolor="#c0c0c0">
                        <td colspan="4"
                    ...
                    <tr>
                        <td colspan="4">{{$datos->email_inst}}</td>
            ...
            <div class="content">
                ...
                <table border="1">
                    ...
                    <tr>
                        ...
                        @endphp
                        <td>{{date("d",$dia_tit)}}</td>
                        <td>{{date("m",$dia_tit)}}</td>
                        <td>{{date("Y",$dia_tit)}}</td>
                        <td>{{$f->napostillado}}</td>
                    </tr>
                    @empty
                    @endforelse
                    </tbody>
    ...
    <div class="row">
        <div class="span12">
            <div class="content">
                <br>
                <table border="0"><tr><td colspan="5"><b></b></td></tr><tr><td colspan="5"><b>III. Capacitaciones Complementarias (Últimos 5 años)</b></td></tr></table>
                <table border="1">
                    <caption></caption>
                    <col>
                    <tbody>
            ...
            <div class="content">
                ...
                <table border="1">
                    ...
                    <tr>
                        ...
                        <td colspan="1">{{$datos->conside_legal_1=="SI"?"X":""}}</td>
                        <td colspan="1">{{$datos->conside_legal_1=="NO"?"X":""}}</td>
                    </tr>
                    <tr>
                        <td colspan="9">2.- Con pago pendiente de reparación civil impuesta por una condena ya cumplida.</td>
                        <td colspan="1">{{$datos->conside_legal_2=="SI"?"X":""}}</td>
                        <td colspan="1">{{$datos->conside_legal_2=="NO"?"X":""}}</td>
                    </tr>
                    <tr>
                        <td colspan="9">3.- Condenado por delito doloso con sentencia de autoridad de cosa juzgada.</td>
                        <td colspan="1">{{$datos->conside_legal_3=="SI"?"X":""}}</td>
                        <td colspan="1">{{$datos->conside_legal_3=="NO"?"X":""}}</td>
                    </tr>
                    <tr>
                        <td colspan="9">4.- Con registro antecedentes penales.</td>
                        <td colspan="1">{{$datos->conside_legal_4=="SI"?"X":""}}</td>
                        <td colspan="1">{{$datos->conside_legal_4=="NO"?"X":""}}</td>
                    </tr>
                    <tr>
                        <td colspan="9">5.-  Consignado en el Registro Nacional de Sanciones contra Servidores Civiles.</td>
                        <td colspan="1">{{$datos->conside_legal_5=="SI"?"X":""}}</td>
                        <td colspan="1">{{$datos->conside_legal_5=="NO"?"X":""}}</td>
                    </tr>
                    </tbody>
                </table>
            </div>
