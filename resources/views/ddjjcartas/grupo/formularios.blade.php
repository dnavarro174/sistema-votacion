            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="card-title text-transform-none">Creación del Formulario - DJ.CGR</h4>
                
                  <form class="forms-sample pr-4 pl-4" id="caiieventosForm" action="{{ route('grupo-djcgr_form.store') }}" method="post" enctype="multipart/form-data" >
                    {!! csrf_field() !!}
                          ...
                          <div class="form-group row">
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="cod_curso" type="checkbox" class="form-check-input" value="1" checked> Código Curso <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="nom_curso" type="checkbox" class="form-check-input" value="1" checked> Nombre Curso <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="grupo" type="checkbox" class="form-check-input" value="1" checked> En condición de colaborador <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="gradoprof" type="checkbox" class="form-check-input" value="1" checked> Nivel <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="form-group row">
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="discapacidad" type="checkbox" class="form-check-input" value="1" checked> Modalidad Contractual <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="opc_0" type="checkbox" class="form-check-input" value="1" checked> Fecha Inicio de Contrato <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="opc_1" type="checkbox" class="form-check-input" value="1" checked> Fecha Fin de Contrato <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12 text-center mt-4">
                        ...
                        <a href="{{ route('grupo-dj.index') }}" class="btn btn-light">Volver atrás</a>
                      </div>
