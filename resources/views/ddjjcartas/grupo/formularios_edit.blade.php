            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample pr-4 pl-4" id="caiieventosForm" action="{{ route('grupo-dj_form.update', $datos->eventos_id) }}" method="post" enctype="multipart/form-data" >
                          ...
                          <div class="form-group row">
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="cod_curso" @if($datos->cod_curso == 1) checked="" @endif type="checkbox" class="form-check-input" value="1"> Código Curso <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="nom_curso" @if($datos->nom_curso == 1) checked="" @endif type="checkbox" class="form-check-input" value="1"> Nombre Curso <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="grupo" @if($datos->grupo == 1) checked="" @endif type="checkbox" class="form-check-input" value="1"> En condición de colaborador<i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="gradoprof" @if($datos->gradoprof == 1) checked="" @endif type="checkbox" class="form-check-input" value="1"> Nivel <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="form-group row">
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="discapacidad" type="checkbox" class="form-check-input" value="1" @if($datos->discapacidad == 1) checked="" @endif> Modalidad Contractual <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="opc_0" type="checkbox" class="form-check-input" value="1" @if($datos->opc_0 == 1) checked="" @endif> Fecha Inicio de Contrato <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="opc_1" type="checkbox" class="form-check-input" value="1" @if($datos->opc_1 == 1) checked="" @endif> Fecha Fin de Contrato <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
