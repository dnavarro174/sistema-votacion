            ...
            <div class="col-md-9 grid-margin stretch-card">
              <div class="card mt-4">
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="estudiantesForm"  action="{{ route('grupo-djcgr.update', $datos->id) }}" method="post"> 
                    {!! method_field('PUT') !!}
                    {!! csrf_field() !!}

                    <div class="form-group row">
                        <label for="nombre_evento" class="col-sm-2 col-form-label ">Grupo  <span class="text-danger">*</span></label>
                        <div class="col-sm-10">
                          <input type="text" required="" class="form-control" name="nombre_evento" placeholder="Nombre del Grupo *" value="{{ $datos->nombre_evento }}" />
                      ...
                      <div class="form-group row campos_opcles @if($datos->auto_conf == 0) d-none @endif">
                        <label for="email_asunto" class="col-sm-3 col-form-label">Asunto para la Confirmación <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" id="email_asunto" name="email_asunto" placeholder="Ejm: Se ha registrado satistactoriamente al..." @if($datos->auto_conf == 1) required="" @endif value="{{ $datos->email_asunto }}" />
                        </div>
                      </div>
                      <div class="form-group row campos_opcles @if($datos->auto_conf == 0) d-none @endif">
                        ...
                        <div class="col-sm-9 capa-email_id {{-- poner espacio --}}">
                          <select class="form-control" id="email_id" name="email_id" @if($datos->auto_conf == 1) required="" @endif>
                      ...
                      <div class="form-group row campos_opcles @if($datos->auto_conf == 0) d-none @endif">
                        ...
                        <div class="col-sm-9">
                          <input type="email" class="form-control" id="fecha_texto" name="fecha_texto" placeholder="Ingrese correo electrónico" value="{{ $datos->fecha_texto }}" />
                        </div>
                      </div>
                      ...
                      <div class="form-group row campos_opcles @if($datos->confirm_email == 0) d-none @endif">
                        <label for="p_conf_registro" class="col-sm-12 col-form-label d-block">Confirmación de registro del evento (HTML) <span class="text-danger">*</span></label>
                        <div class="col-sm-12">
                          <textarea placeholder="Confirmación de registro del evento (HTML)" class="form-control" name="p_conf_registro" id="p_conf_registro" cols="30" rows="10"></textarea>
                          <div class="col alert alert-light border-0 mb-0 text-right">
                            10,000 caracteres
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-12">
                          <textarea placeholder="Confirmación de registro del evento (Whatsapp)" class="form-control" name="p_conf_registro_2" id="p_conf_registro_2" cols="30" rows="10">{{ $datos->p_conf_registro_2 }}</textarea>
                          <div class="col alert alert-light border-0 mb-0 text-right">
                            10,000 caracteres
                          </div>
                        </div>
                      ...
                      <div class="form-group row campos_opcles">
