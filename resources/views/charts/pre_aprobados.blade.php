              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="d-flex justify-content-between align-item-center">
                    <h4 class="card-title text-transform-none">Reporte: Preinscritos Registrados <a class="btn btn-link" href="{{ URL::previous() }}">Volver al listado</a></h4>
                  ...
                  <div class="row justify-content-between align-middle px-2 mb-4">
                    <div class="d-flex">
                      <p>
                        <strong>Total:</strong> {{$total}} participantes aceptados
                      </p>
                    </div>
                    <div class="d-flex text-right">
                      
                      <a href="{{ route('reportes.g_exp', ['id'=>1.2])}}" class="btn btn-small btn-dark d-none d-sm-block"><i class="mdi mdi-cloud-check text-white icon-btn"></i> Descargar Excel</a>
                      </div>
                    <div class="d-flex text-right d-block d-sm-none">
                      <a title="Descargar Excel" href="{{ route('reportes.g_exp', ['id'=>1.2])}}" class="px-1"><i class="mdi mdi-cloud-check text-dark icon-btn"></i></a>
                    </div>
                  </div>
