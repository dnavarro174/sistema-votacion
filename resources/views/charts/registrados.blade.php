            ...
            <div class="col-md-10 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="card-title text-transform-none">Reporte: Invitados Registrados <a class="btn btn-link" href="{{ URL::previous() }}">Volver al listado</a></h4>
                  ...
                  <div class="row justify-content-between align-middle px-2 mb-4">
                    ...
                    <div class="d-flex text-right">
                      <a href="{{ route('reportes.g_exp', ['id'=>1.4])}}" class="btn btn-small btn-dark d-none d-sm-block"><i class="mdi mdi-cloud-check text-white icon-btn"></i> Descargar Excel</a>
                    </div>
                    <div class="d-flex text-right d-block d-sm-none">
                      <a title="Descargar Excel" href="{{ route('reportes.g_exp', ['id'=>1.4])}}" class="px-1"><i class="mdi mdi-cloud-check text-dark icon-btn"></i></a>
                    </div>
                  </div>
