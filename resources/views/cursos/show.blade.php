                  ...
                  <p class="card-description">
                    ...
                    <div class="row">
                      <div class="col-sm-12 form-group">
                        ...
                        <input type="text" class="form-control border-primary text-uppercase" id="nom_curso" name="nom_curso" placeholder="Curso" disabled value="{{ $cursos_datos->nom_curso or old('nom_curso') }}" >
                    ...
                    <div class="row">
                      <div class="col-sm-12 form-group">
                        ...
                        <textarea class="form-control border-primary" name="descripcion" id="descripcion" rows="4" disabled>{{ $cursos_datos->descripcion or old('descripcion') }}</textarea>
