            ...
            <div class="col-md-9 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample pr-4 pl-4" id="caiieventosForm" action="{{ route('grupo-estudio-investigacion.store') }}" method="post">
                    {!! csrf_field() !!}
                    
                      <div class="form-group row">
                        <label for="nombre_periodo" class="col-sm-3 col-form-label d-block">Título del formulario <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
                          <input type="text" required="" class="form-control" name="nombre_periodo" placeholder="Título" value="{{ old('nombre_periodo') }}" />
                          
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="descripcion" class="col-sm-3 col-form-label">Sub Título </label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="descripcion" placeholder="Sub Título" value="{{ old('descripcion') }}" />
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="fecha_texto" class="col-sm-3 col-form-label">Fecha en Texto </label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="fecha_texto" placeholder="Lima, Perú - 2 y 3 de Diciembre, 2019" value="{{ old('fecha_texto') }}" />
                        </div>
                      </div>
                      
                      <div class="form-group row">
                        <label for="fechai_periodo" class="col-sm-3 col-form-label d-block">Fecha Inicio <span class="text-danger">*</span></label>
                        <div class="col-sm-4">
                      ...
                      <div class="form-group row">
                        <label for="fechaf_periodo" class="col-sm-3 col-form-label d-block">Fecha Fin <span class="text-danger">*</span></label>
                        <div class="col-sm-4">
                      ...
                      {{-- <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="email" class="form-control" name="fecha_texto" placeholder="Ingrese correo electrónico" value="{{ old('fecha_texto') }}" />
                        </div>
                      </div> --}}


                      <div class="form-group row">
                        <label for="vacantes" class="col-sm-3 col-form-label">Vacantes <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
                      ...
                      <div class="form-group row">
                        <label for="auto_conf" class="col-sm-3 col-form-label">Tendrá Confirmación</label>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="email_asunto" placeholder="Ejm: Registro Exitoso" required="" value="{{ old('email_asunto') }}" />
                        </div>
                      </div>
                      <div class="form-group row">
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12 text-center mt-4">
                        ...
                        <a href="{{ route('grupo-estudio-investigacion.index') }}" class="btn btn-light">Volver al listado</a>
                      </div>
