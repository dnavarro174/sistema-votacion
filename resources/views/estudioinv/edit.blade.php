            ...
            <div class="col-md-9 grid-margin stretch-card">
              <div class="card mt-4">
                <div class="card-body">
                  ...
                  <form class="forms-sample pr-4 pl-4" id="estudiantesForm"  action="{{ route('grupo-estudio-investigacion.update', $datos->id) }}" method="post"> 
                    {!! method_field('PUT') !!}
                    {!! csrf_field() !!}

                    <div class="form-group row">
                        <label for="nombre_evento" class="col-sm-3 col-form-label ">Título del formulario <span class="text-danger">*</span></label>
                        <div class="col-sm-9">
                          <input type="text" required="" class="form-control" name="nombre_evento" placeholder="Título" value="{{ $datos->nombre_evento }}" />
                          <input type="hidden" name="cod_plantilla" value="{{$datos->id}}">{{-- cod_plantilla --}}
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="descripcion" placeholder="Sub Título" value="{{ $datos->descripcion }}" />
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="fecha_texto" class="col-sm-3 col-form-label">Fecha en Texto </label>
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name="fecha_texto" placeholder="Lima, Perú - 2 y 3 de Diciembre, 2019" value="{{ $datos->fecha_texto }}" />
                        </div>
                      </div>

                      {{-- evento para controlar el evento --}}
                      <div class="form-group row">
                        <label for="fechai_evento" class="col-sm-3 col-form-label ">Fecha Inicio <span class="text-danger">*</span></label>
                        <div class="col-sm-4">
                      ...
                      <div class="form-group row">
                        <label for="fechaf_evento" class="col-sm-3 col-form-label d-block">Fecha Fin <span class="text-danger">*</span></label>
                        <div class="col-sm-4">
                      ...
                      {{-- <div class="form-group row">
                        <label for="fecha_texto" class="col-sm-2 col-form-label">Confirmación con copia </label>
                        <div class="col-sm-10">
                          <input type="email" class="form-control" name="fecha_texto" placeholder="Ingrese correo electrónico" value="{{ $datos->fecha_texto }}" />
                        </div>
                      </div> --}}
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9 capa-auto_conf {{-- poner espacio --}}">
