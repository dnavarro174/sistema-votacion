            ...
            <div class="col-md-9 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample pr-4 pl-4" id="caiieventosForm" action="{{ route('grupo-doc.store') }}" method="post">
                    {!! csrf_field() !!}
                      ...
                      <div class="form-group row">
                        <label for="lugar" class="col-sm-2 col-form-label">Código <span class="text-danger">*</span></label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="lugar" placeholder="2019-02-C" required="" value="{{ old('Código') }}" />
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        <label for="fecha_texto" class="col-sm-2 col-form-label">Confirmación con copia <span class="text-danger">*</span></label>
                        <div class="col-sm-10">
                          <input type="email" class="form-control" name="fecha_texto" placeholder="Ingrese correo electrónico" required="" value="{{ old('fecha_texto') }}" />
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9 capa-email_id {{-- poner espacio --}}">
                          <select class="form-control" id="email_id" name="email_id" required readonly>
                            <option value="">SELECCIONE / CHANGE</option>
                            @foreach($emails as $e)
                            <option @if($e->id == 4) selected @endif value="{{$e->id}}">{{$e->nombre}} - {{$e->email}}</option>
                            @endforeach
                          </select>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12 text-center mt-4">
                        ...
                        <a href="{{ route('grupo-doc.index') }}" class="btn btn-light">Volver al listado</a>
                      </div>
