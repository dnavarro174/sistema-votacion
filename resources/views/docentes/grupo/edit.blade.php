            ...
            <div class="col-md-9 grid-margin stretch-card">
              <div class="card mt-4">
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="estudiantesForm"  action="{{ route('grupo-doc.update', $datos->id) }}" method="post"> 
                    {!! method_field('PUT') !!}
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" name="lugar" placeholder="2019-02-C" required="" value="{{ $datos->lugar }}" />
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                          <input type="email" class="form-control" name="fecha_texto" placeholder="Ingrese correo electrónico" required="" value="{{ $datos->fecha_texto }}" />
                        </div>
                      </div>
