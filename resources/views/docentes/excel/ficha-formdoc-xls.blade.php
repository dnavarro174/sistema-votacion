                ...
                <div class="content">
                    ...
                    <table border="1" class="w-100">
                        ...
                        <tr>
                            ...
                            <td colspan="1" class="center">{{$c->fecha_inicio_cap}}</td>
                            <td colspan="1" class="center">{{$c->fecha_fin_cap}}</td>
                ...
                <div class="content">
                    ...
                    <table border="1" class="w-100">
                        ...
                        <tr>
                            ...
                            <td colspan="1" class="center">{{$exp->fecha_inicio_lab}}</td>
                            <td colspan="1" class="center">{{$exp->fecha_fin_lab}}</td>
                        </tr>
                        @empty
                        @endforelse
                        </tbody>
                ...
                <div class="content">
                    ...
                    <table class="w-100" border="1">
                        ...
                        <tr>
                            ...
                            <td colspan="1" class="center">{{$exp->fecha_inicio_exp}}</td>
                            <td colspan="1" class="center">{{$exp->fecha_fin_exp}}</td>
                        </tr>
                        @empty
                        @endforelse
                        </tbody>
