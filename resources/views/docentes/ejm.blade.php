                      ...
                      <h2 class="text-dark  text-center mb-4 pb-4">PARA LA MAESTRÍA EN CONTROL GUBERNAMENTAL</h2>
                          ...
                          <div class="row pt-5 mt-5 text-center ">
                              <div class="col-xs-12 col-md-3 mx-auto">
                                  <input type="text" name="solicitante" class="form-control" style="border-top: 2px solid" value="{{ old('solicitante', 'Alzamora Acosta, Victor Manuel') }} ">
                                  <label for="tipo_bs">Solicitante</label>
                              </div>
                              <div class="col-xs-12 col-md-3 mx-auto">
                                  <input type="text" name="gerente" class="form-control" style="border-top: 2px solid" value="{{ old('gerente', 'Horna Gonzales, Felix Esteban') }} ">
