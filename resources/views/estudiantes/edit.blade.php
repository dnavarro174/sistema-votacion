                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="estudiantesForm"  action="{{ route('estudiantes.update', $estudiantes_datos->id) }}" method="post">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-2 form-group">
                        <label class=" col-form-label" for="cboTipDoc">Modalidad <span class="text-danger">*</span></label>
                        <select class="form-control text-uppercase" required name="mod" id="mod">
                          <option value="">SELECCIONAR</option>
                          @foreach($modalidades as $mod)
                          <option value="{{$mod->modalidad_id}}" 
                            @if ($mod->modalidad_id === $estudiantes_datos->modalidad_id) selected @endif
                      ...
                      <div class="col-sm-12 text-center mt-4">
                        ...
                        <div class="btn-group" role="group">
                          ...
                          <div class="dropdown-menu bg-light" aria-labelledby="btnGroupDrop1">
                            <a class="dropdown-item solicitud" data-tipo='preregistro' data-dni='{{$estudiantes_datos->dni_doc}}' data-evento='{{$eventos_id}}' href="#">Enviar Confirmación pre-registro</a>
                            <a class="dropdown-item solicitud" data-tipo='invitacion' data-dni='{{$estudiantes_datos->dni_doc}}' data-evento='{{$eventos_id}}' href="#">Enviar Aprobación</a>
                            <a class="dropdown-item solicitud" data-tipo='confirmacion' data-dni='{{$estudiantes_datos->dni_doc}}' data-evento='{{$eventos_id}}' href="#">Enviar Inscripción</a>
                            <a class="dropdown-item solicitud" data-tipo='recordatorio' data-dni='{{$estudiantes_datos->dni_doc}}' data-evento='{{$eventos_id}}' href="#">Enviar Recordatorio</a>
                          </div>
                        </div>
                          <a href="{{ route('caii.seleccionar',['eventos_id'=>$eventos_id])}}" target="_blank" class="btn btn-danger ml-2">Registrar</a>
            ...
            <div class="col-lg-12 stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="card-title">HISTORIAL DE: {{$estudiantes_datos->nombres }}- {{$estudiantes_datos->ap_paterno }}</h4>
                        <table class="table table-striped">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                  @if($estudiantes_datos->modalidad_id==1)
                                  ...
                                  @else
                                  <label class="badge badge-danger">NO TIENE Part. Virtual</label>
                                  @endif
                                </td>
                                <td>
                                  <?php 
