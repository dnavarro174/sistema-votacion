    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        ...
        <div class="content-wrapper p-0 mt-3">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">ENVÍOS DE EMAILS</h4>
              <div class="row" id="capBusqueda" style="display: block;">
                <div class="col-12 form-inline">
                  
                  <form action="{{ route('estudiantes.enviar_email') }}" method="GET" class="form-inline pull-right">
                    ...
                    <?php
                     if (isset($_GET['s'])){ ?>
                     <a class="ml-2 small" href=' {{route('estudiantes.enviar_email')}} '>Borrar busqueda</a>
                    <?php } ?>
                  </form>
                </div>
              </div>
