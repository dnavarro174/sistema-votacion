                      ...
                      <div class=" col-sm-1 col-xs-12">
                        <select class="form-control" name="apro" id="apro" >
                          <option value="">APRO / NO APRO</option>
                            <option {{ app('request')->input('apro')=='SI' ? 'selected':'' }} value="SI">APROBADOS</option>
                            <option {{ app('request')->input('apro')=='NO' ? 'selected':'' }} value="NO">NEGADOS</option>
                            <option {{ app('request')->input('apro')=='N' ? 'selected':'' }} value="N">NO APROBADOS</option>
                        </select>
                      </div>
                      <div class=" col-sm-1 col-xs-12">
                      ...
                      <div class="col-sm- form-group">
                          <label class="d-block col-form-label mt-2">
                              <input type="checkbox" id="chkNo" name="inv" value="1"><span id="spanConceder">
                                Convertir a Virtual
                                  {{--AGREGAR CAMBIO HARRY Rechazar Pre-Inscripciones --}}
                              </span>
                          </label>
                      </div>
                    </div>
                ...
                <div class="col-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12  col-sm-8 text-left mb-4">
                      ...
                      <button  type="submit" class="btn btn-secondary d-none d-sm-inline-block" name="enviar_confirmacion" id="enviar_confirmacion"><i class="mdi mdi-arrow-right-bold"></i> Enviar Confirmación</button>
                      <button  type="submit" class="btn btn-secondary d-inline-block d-sm-none" name="enviar_confirmacion" id="enviar_confirmacion"><i class="mdi mdi-arrow-right-bold"></i> Confirmación</button>
                      ...
                      <a href="{{request()->fullUrlWithQuery(["export"=>1])}}" class="btn btn-sm btn-success d-none d-sm-inline-block" id="exportar" >Exportar</a>
                      <a href="{{request()->fullUrlWithQuery(["export"=>1])}}" class="btn btn-sm btn-success d-inline-block d-sm-none" title='Descargar' id="exportar" >
                              ...
                              <td nowrap="">
                                ...
                                <td>
                                    <input type="checkbox" class="aemail"
                                      <?php if($datos->dtrack == "SI" or $datos->dtrack == "NO") echo "disabled"?>
...
<script>
    (function($) {
        ...
        function verificaBoton(){
            ...
            var msg = '';
            if(random<=0)msg='Indicar un número valido';/*Random invalido*/
        ...
        function CambiarTextoConfirmacion(){
            var msg = $chkNo.prop('checked') ? 'ENVIAR' : 'SORTEAR';
