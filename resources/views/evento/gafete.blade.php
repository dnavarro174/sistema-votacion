					...
					<div class="div1">
			 			<table width="290" border="0" cellpadding="0" cellspacing="0" class="table">
						  <tbody>
							...
							{{-- <tr>
						  		<td width="30%" class="foro_1">
						  			<strong class="color_oscuro">06 dic<br> 14:30 hrs.</strong> 
						  		</td>
						  		<td colspan="2" class="foro_2" width="70%"><strong>{{ $foro_1_tit }}:</strong> {{ $foro_1 }} </td>
						  	</tr>
							<tr>
							  <td colspan="3"><br />
							  </td>
							...
							<tr>
							  		...
							  		<td colspan="2" class="foro_2" width="70%"><strong>{{ $foro_2_tit }}:</strong> {{ $foro_2 }} </td>
							</tr> --}}
							<tr>
							  <td colspan="3"><br>
							  </td>
							...
							<tr>
							  <td colspan="3" class="full_width" valign="bottom">
							  	<img src="http://enc-ticketing.org/tkt/caii/img-gafete/foot.png" alt="footer" style="width: 377px;"/>
