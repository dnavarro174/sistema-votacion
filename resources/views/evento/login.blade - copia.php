                  ...
                  <div class="row justify-content-center">
                    <div class="col-xs-12 col-md-8">
                      <form class="forms-sample" id="loginCAII" action="{{ route('caii.validacionlogin') }}" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            <input id="text" type="text" placeholder="USUARIO" class="form-control h4 {{ $errors->has('username') ? ' is-invalid' : '' }}" name="username" value="{{ old('username') }}" required autofocus>
                        ...
                        <div class="input-group">
                          <input id="password" type="password" placeholder="*********" class="form-control h4{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required>
                      ...
                      <div class="form-group text-center">
                        <button class="btn btn-dark submit-btn ">{{ __('Ingresar / Login') }}</button>
