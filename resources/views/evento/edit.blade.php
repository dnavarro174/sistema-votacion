                    ...
                    <div class="col-sm-12 col-md-12  grid-margin stretch-card">
                      <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <p class="card-text">
                            Para el correcto registro de su participación al evento, agradeceremos validar sus datos:
                          </p>
                          <p class="card-text" style="color:#999;">
                            For the correct registration of your participation in the event, we would appreciate validating your data:
                          </p>
                          ...
                          <div class="row">
                              ...
                              <div class="form-group">
                                ...
                                <div class="input-group mb-2">
                                  <div class="input-group-prepend w-100">
                                    <select readonly class="form-control" required="" name="tipo_doc" id="cboTipDoc" class="codigo_cel">
                            ...
                            <div class="col-sm-12 col-md-4">
                              <div class="form-group">
                                ...
                                {!! $errors->first('codigo_cel', '<span class=error>:message</span>') !!}
                              </div>
                            </div>
                            <div class="col-sm-12 col-md-4">
                              <div class="form-group">
                              ...
                              <div class="form-group ">
                                ...
                                <div class="form-check">
                                  <label class="form-check-label" for="enc">
                                    ...
                                    He leído y acepto los <a href="#" onclick="eximForm()" data-toggle="modal">Términos y Condiciones</a>
                                  
                                  </label>

                                  <p style="padding-left: 10px;">I have read and accept the  Terms and Conditions</p>
                                </div>
                              </div>
