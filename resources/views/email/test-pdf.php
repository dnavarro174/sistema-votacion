...
<html>
   ...
   <body>
      <div class="container img_footer">
         <div class="capa_1 bg_red">
            <img src="https://enc-ticketing.org/comunicaciones/encomunicacion/EVENTOS_2022/12.diciembre/observatorio/gafete/banner_1.png" alt="logo header" width="315">
         </div>
         <div class="capa_2">
            <h2>Lanzamiento del Observatorio<br>
               Nacional Anticorrupción de la CGR Perú</h2>

            <h4>Foro Internacional<br>
               "La Corrupción bajo la lupa"</h4>
         </div>
         <div class="capa_3 bg_red">
            <table style='text-align:center;'>
               <tr>
                  <td>
                     <p class='img'>
                        <img src="https://enc-ticketing.org/comunicaciones/encomunicacion/EVENTOS_2022/12.diciembre/observatorio/gafete/ico_1.png" width="41" height="41" alt="icono fecha">
                     </p>
                     <p class="text">
                     FECHA<br>
                  ...
                  <td >
                     <p class='img'>
                        <img src="https://enc-ticketing.org/comunicaciones/encomunicacion/EVENTOS_2022/12.diciembre/observatorio/gafete/ico_2.png" width="39" height="39" alt="icono fecha">
                     </p>
                     <p class="text">
                     HORA DE INGRESO<br>
                     <strong>08:30 a.m.</strong>
                     </p>
                  </td>
                  <td>
                     <p class='img'>
                        <img src="https://enc-ticketing.org/comunicaciones/encomunicacion/EVENTOS_2022/12.diciembre/observatorio/gafete/ico_3.png" width="33" height="39" alt="icono fecha">
                     </p>
                     <p class="text">
                        LUGAR <br>
                        <strong>Auditorio ENC</strong>
                     </p>
                  </td>
               </tr>
            </table>
