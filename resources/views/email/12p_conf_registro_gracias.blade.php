...
<table align="center" width="650" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0">
    ...
    <td><table align="center" width="580" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          ...
          <tr>
            <td font style><p align="center" style="font-family: 'Calibri'; font-size: 30px; color: #00418B; text-align: justify">Sus datos han sido registrados correctamente.
            Le esperamos el <strong>28 de noviembre</strong> a partir de las <strong>18:00 horas</strong>.<br>
            <br>
            También puede ver esta información a través de la cuenta de correo electrónico registrado.
			<br></td>
          </tr>
          <tr>
            <td height="30px">&nbsp;</td>
...
<table  align="center" width="650" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0" >
    ...
    <td style="font-family:arial"><table width="650" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          <tr>
            <td width="65">&nbsp;</td>
            <td font style><p align="center" style="font-family: 'Calibri'; font-size: 14px; color: #000000; text-align: justify">En caso no pueda asistir puede ver la transmisión del evento en nuestras redes sociales:</td>
            <td width="65">&nbsp;</td>
          </tr>
          <tr>
            <td width="65">&nbsp;</td>
