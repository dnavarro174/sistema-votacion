<meta charset="utf-8">
      ...
      <div class="container img_footer">
         ...
         <div class="capa_2">
            <h2>TALLER: TRANSICIÓN Y ADOPCIÓN Al MARCO DE  LaS nicsp en el PERÚ, CASOS PRÁCTICOS</h2>

            <h4 style="font-size: 8px;">
               LUGAR: <strong>Escuela Nacional de Control. Aula SUM 51-52.<br> 
                 ...
                 <td>
                   <p class="img">
                    ...
                    <p class="text">
                     FECHA:<br>
                    <strong>13 y 14 <br>
                    </strong><strong>de enero</strong>                    </p>
                  </td>
                 <td>
                     <p class="img">
