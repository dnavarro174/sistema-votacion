<html>
   ...
   <body>
      <div class="container img_footer">
         ...
         <div class="capa_2">
            <h2>Presentación del Índice de <br>
               Riesgos en Inversión (IRI) de la CGR</h2>

            <h4 style="font-size: 8px;">
               LUGAR: <strong>Auditorio Ing. Antonio Blasco Blanco del Colegio de<br> Ingenieros del Perú (Av. Prescott N° 225 - San Isidro, Lima)</strong>
            </h4>
         </div>
