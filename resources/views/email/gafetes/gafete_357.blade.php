<meta charset="utf-8">
      ...
      <div class="container img_footer">
         ...
         <div class="capa_2">
            <h2>Semana Internacional de la Investigación <br>
               "Reflexiones para una agenda de investigación en la intersección del control gubernamental, la gestión pública y la lucha contra la corrupción"</h2>

            <h4 style="font-size: 8px;">
               LUGAR: <strong>SUM 51-52 Escuela Nacional de Control<br> Bartolomé Herrera 255 Lince</strong>
            </h4>
         </div>
