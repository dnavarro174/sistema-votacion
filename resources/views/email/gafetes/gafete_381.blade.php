<meta charset="utf-8">
      ...
      <div class="container img_footer">
         ...
         <div class="capa_2">
            <h2>CEREMONIA DE CLAUSURA DE LA MAESTRÍA EN CONTROL GUBERNAMENTAL Y LA SEGUNDA ESPECIALIDAD PROFESIONAL EN CONTROL GUBERNAMENTAL 2025 </h2>
               ...
               <tbody><tr>
                 <td>
                   <p class="img">
                    ...
                    <p class="text">
                     FECHA:<br><strong>21 de febrero</strong>
                    </p>
                  </td>
                 <td>
                     <p class="img">
