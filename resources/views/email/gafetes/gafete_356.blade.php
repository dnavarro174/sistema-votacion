<meta charset="utf-8">
      ...
      <div class="container img_footer">
         ...
         <div class="capa_2">
            <h2>CONVERSATORIO: “LOS EFECTOS DEL CONTROL CONCURRENTE SOBRE LA INVERSIÓN PÚBLICA: RESULTADOS DE LA EVALUACIÓN DE IMPACTO 2018-2023”

 <br>
               </h2>

            <h4 style="font-size: 8px;">
               LUGAR: <strong>Auditorio JJ Wicht de la Universidad del Pacífico Jr. Sánchez Cerro 2121, Jesús Maria</strong>
            </h4>
        </div>
