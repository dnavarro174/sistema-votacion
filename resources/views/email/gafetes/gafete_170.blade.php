   ...
   <head>
      ...
      <style>
        body{font-size: 14px;font-family: Arial, "Helvetica Neue", Helvetica, sans-serif;color: #444; }
         ...
         .color_oscuro{color:#556685;font-size: 12px;font-weight: bold;text-align: center;text-transform: uppercase;}
         /*td{overflow:hidden;white-space:nowrap;text-overflow:ellipsis}*/
         .foro_1{white-space: inherit;text-align: center;vertical-align: top;font-size:12px;padding-bottom:2px;}
            ...
            <div class="div1">
               <table width="290" border="0" cellpadding="0" cellspacing="0" class="table">
                  <tbody>
                     ...
                     <tr> 
                        <td class="foro_1 titulo_act" colspan="3"><span>Mis actividades:</span></td>
                     </tr>
