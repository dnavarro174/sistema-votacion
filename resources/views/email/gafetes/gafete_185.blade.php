...
<html>
   ...
   <body>
      <div class="container">
         ...
         <div style="margin-left: 50px;">
            <table>
               <tr>
                  ...
                  <td width="20"> </td>
                  <td class="">
                     <span class="titulo_top"><strong><span style="color: brown">PRESENTE</span></strong><span style="color: black"> este gafete desde su dispositivo movil al momento de ingresar al evento </span>
         ...
         <br>
         <div style="margin-left: 50px;">
            <span style="font-size: 14px; font-family: Arial,Helvetica Neue, Helvetica, sans-serif;">
				1. Presentar su carnet de vacunación.
			 </span><br>
            <span style="font-size: 14px; font-family: Arial,Helvetica Neue, Helvetica, sans-serif;">
				2. Asistir con doble mascarilla o KN95..
			 </span><br>
            <span style="font-size: 14px; font-family: Arial,Helvetica Neue, Helvetica, sans-serif;">
				3. Recuerde que debe presentarse media hora antes del inicio del evento.
			 </span><br>
			  <span style="font-size: 14px; font-family: Arial,Helvetica Neue, Helvetica, sans-serif;">
				4. Aforo limitado.
			 </span><br>
                     ...
                     <!-- BEGIN CODIGO -->
                      <tr>
                        <td align="center" colspan="3" class="fecha_txt">
                           <strong style="font-size: 25px"><?php echo $fecha->fecha_inicio; ?></strong>
                        </td>
                     </tr>
