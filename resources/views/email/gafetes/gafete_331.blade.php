   ...
   <head>
      ...
      <style>
        body{font-size: 14px;font-family: Arial, "Helvetica Neue", Helvetica, sans-serif;color: #444; }
         ...
         .act{padding-left: 24px;color:#232323;font-size: 15px;margin:15px;font-weight: bold;padding-bottom: 5px;text-align: left;}
      </style>
   </head>
   <body>
      <div class="container">
            ...
            <div class="div1">
               <table border="0" cellpadding="0" cellspacing="0" class="table">
                  <tbody>
                     ...
                     <tr> <td colspan="3" class="act">Mis Actividades<br /> </td> </tr>
                     <!-- BEGIN CODIGO -->
