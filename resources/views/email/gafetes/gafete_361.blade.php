<meta charset="utf-8">
      ...
      <div class="container img_footer">
         ...
         <div class="capa_2">
            <h2>Índice de Riesgos de Corrupción e Inconducta Funcional (INCO) 2024</h2>

            <h4 style="font-size: 8px;">
               LUGAR: <strong>Auditorio de la Escuela Nacional de Control<br> Bartolomé Herrera 255 Lince</strong>
            </h4>
         </div>
