    ...
    <td><table align="center" width="580" border="0" cellspacing="0" cellpadding="0">
        <tbody>
          ...
          <tr>
            ...
            Le esperamos el <strong>2 y 3 de diciembre</strong> a partir de las <strong>07:45 horas</strong>.<br>
            <br>
            También puede ver esta información a través de la cuenta de correo electrónico registrado.
				<br> <br> <p align="center" style="font-family: 'Calibri'; font-size: 20px; color: #0054B3; text-align: justify;)">Your personal information has been registered correctly. We welcome you on <strong>December 2 and 3</strong> starting <strong>07:45 hrs.</strong><br> 
				<br> You can also view this information through the registered email account.</p></td>
          </tr>
          <tr>
            <td height="30px">&nbsp;</td>
          </tr>
