            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="tipo_docForm"  action="{{ route('tipo_doc.update', $tipo_doc_datos->id) }}" method="post">
                    {!! method_field('PUT') !!}
                    {!! csrf_field() !!}
                    <div class="row">
                      <div class="col-sm-12 form-group">
                        <label class="col-form-label">Tipo Documento</label>
                        <input type="text" class="form-control border-primary" id="inputTipoDoc" name="inputTipoDoc" placeholder="Nombre de documento" value="{{ $tipo_doc_datos->tipo_doc }}" autofocus>
