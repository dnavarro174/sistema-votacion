                  ...
                  <p class="card-description">
                    ...
                    <div class="row">
                      <div class="col-sm-12 form-group">
                        ...
                        <textarea type="text" class="form-control border-primary text-uppercase" id="descripcion" name="descripcion" rows="4" disabled="">{{ $eventos_datos->descripcion }}</textarea>
                    ...
                    <div class="row">
                      <div class="col-sm-4 form-group">
                        ...
                        <div id="datepicker-popup" class="input-group date datepicker border-primary">
                          <input type="text" name="fecha_inicio" class="form-control border-primary text-uppercase" placeholder="01/01/2018" disabled value="{{ $eventos_datos->fecha_inicio }}">
                      ...
                      <div class="col-sm-4 form-group">
                        ...
                        <div id="datepicker-popup2" class="input-group date datepicker border-primary">
                          <input type="text" name="fecha_fin" class="form-control border-primary text-uppercase" placeholder="01/01/2018" disabled value="{{ $eventos_datos->fecha_fin }}">
                          <span class="input-group-addon input-group-append border-left">
                            <span class="mdi mdi-calendar input-group-text"></span>
                          </span>
                        </div>
                      ...
                      <div class="col-sm-4 form-group">
                        ...
                        <select class="form-control border-primary text-uppercase" id="tipo_evento_id" name="tipo_evento_id" disabled>
