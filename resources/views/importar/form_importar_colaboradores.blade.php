{{-- Importar Cursos --}}
<div class="modal fade ass" id="Modal_estudiantes" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="background: #00000047;">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <form  id="f_cargar_cursos" name="f_cargar_cursos" method="post"  action="{{ route('colaboradores.import') }}" class="formarchivo" enctype="multipart/form-data" >
            {!! csrf_field() !!}
      ...
      <div class="modal-content" style="max-height: 600px;">
        ...
        <div class="card">
          <div class="card-body" style=" overflow: scroll;max-height:520px;">
            <iframe src="{{ route('colaboradores.importresults') }}" frameborder="1" width="100%" height="400" id="iframePrev" style="display:none; border: 1px solid #e6e6e6;"></iframe>
  
            <form class="form-inline"  id="estudiantesImportSave" name="estudiantesImportSave" action="{{ route('colaboradores.importsave') }}" method="post" style="display:block;">
              {!! csrf_field() !!}
            <div class="row">
