 {{-- Importar Cursos --}}
 <div class="modal fade" id="modalImportar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="background: #00000047;">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-12">
                <div class="dropify-wrapper"><div class="dropify-message"><span class="file-icon"></span> <p>Seleccione el archivo .xls o .csv</p><p class="dropify-error">Ooops, nose ha adjuntado</p></div><div class="dropify-loader"></div><div class="dropify-errors-container"><ul></ul></div>
                  ...
                  <input type="file" name="file" id="archivo_import" class="dropify" required accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel">
      ...
      <div class="modal-content" style="max-height: 600px;">
        ...
        <div class="card">
          <div class="card-body" style=" overflow: scroll;max-height:520px;">
            ...
            <form class="form-inline"  id="estudiantesImportSave" name="estudiantesImportSave" data-url="{{url('')}}/colaboradores_importsave" action="{{ route('cursos.importsave') }}" method="post" style="display:block;">
              {!! csrf_field() !!}
            <div class="row">
            ...
            <div class="row">
                ...
                <input type="hidden" valido name="tipo_dj" id="tipo_dj" value="{{$_GET['tipo']}}">
                <input type="hidden" valido name="tipo_form" id="tipo_form" value="curso">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-secondary" id="btnCerrar_curso">Cerrar</button>
