                      ...
                      <div class="col-sm-2 form-group">
                        ...
                        <select class="form-control text-uppercase" required="" name="cboTipDoc" id="cboTipDoc">
                            ...
                            @foreach($tipo_doc as $tipoDoc)
                              <option @if($tipoDoc->id==1)selected=""@endif value="{{ $tipoDoc->id }}">{{ $tipoDoc->tipo_doc }}</option>
                            @endforeach
                        </select>
                      </div>
                      <div class="col-sm-2 form-group">
                    ...
                    <?php
                      ...
                      if(isset($_GET['tipo'])){
                          ...
                          $ruta = route('leads.index', array('tipo'=>$_GET['tipo'])); //URL::previous();
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12 text-center mt-4">
                        ...
                        {{-- <a href="{{ route('leads.index') }}" class="btn btn-light">Volver al listado</a> --}}
                      </div>
