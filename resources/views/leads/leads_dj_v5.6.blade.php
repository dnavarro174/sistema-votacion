                    ...
                    <div class="form-row">
                      ...
                      <div class=" col-sm-1 col-xs-12">
                        <select class="form-control" name="reg" id="filter-by-date" onchange="submit();">
                          <option selected="selected" value="">APROBADOS</option>
                          <option value="1">SI</option>
                          <option value="2">NO</option>
                        </select>
                      </div>
                          ...
                          <tbody>
                            ...
                            <tr role="row" class="odd" style="background: {{ $bg }}">
                              <td><input type="checkbox" class="form btn-delete" name="tipo_doc[]" value="{{ $datos->id_dj }}" data-id="{{ $datos->id_dj }}"></td>
                                ...
                                <td class="text-center">{{ $datos->preg_1 or '' }}</td>
                                <td class="text-center">{{ $datos->preg_2 or '' }}</td>
                                <td class="text-center">{{ $datos->preg_3 or '' }}</td>
                                <td class="text-center">{{ $datos->preg_4 or '' }}</td>
                                <td class="text-center">{{ $datos->preg_5 or '' }}</td>
                                <td class="text-center">{{ $datos->preg_6 or '' }}</td>
                            </tr>
                            @endforeach
