                ...
                <div class="col-12">
                  ...
                  <div class="row">{{-- cap: opciones --}}
                    ...
                    <div class="col-xs-12  col-sm-8 text-left mb-4">
                      ...
                      <a href="#" id="Recordatorio" class="btn btn-sm btn-dark" data-id='{{session('eventos_id')}}' data-mod='eventos'><i class="mdi mdi-email icon-md"></i>Recordatorio</a>
                      @endif
                        ...
                        <table id="order-listing" class="table table-hover table-sm">
                          <thead class="thead-dark">
                            <tr role="row">
                              ...
                              <th style="width: 5%;">Email 2</th>
                              <th style="width: 5%;">Se_Entero</th>
                              <th style="width: 5%;">Interesado</th>
                              @endif
                          ...
                          <tbody>
                            ...
                            <tr role="row" class="odd" <?php if($datos->dtrack == "SI") echo "style='background:#a0e8c5;'"?> <?php if($datos->dtrack == "NO") echo "style='background:#f7d3d3;'"?>>
                              ...
                              <td nowrap="">
                                ...
                                @endif
                                <td><span title="{{$datos->c2_social}}">{{ \Illuminate\Support\Str::limit($datos->c2_social,50) }}</span></td>
                                <td>{{ $datos->c1_tpo_landing }}</td>
