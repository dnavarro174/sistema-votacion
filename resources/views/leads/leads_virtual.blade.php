          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center">
                <h4 class="card-title">Leads / Registros <span class="badge badge-dark">Virtual</span>
                  ...
                  <div class="row">{{-- cap: opciones --}}
                    ...
                    <div class="col-xs-12  col-sm-8 text-left mb-4">
                      @if(@isset($permisos['nuevo']['permiso']) and  $permisos['nuevo']['permiso'] == 1)
                        {{-- <a href="{{ route('leads.create', ['tipo'=>2]) }}" title="Agregar" class="btn btn-dark btn-sm icon-btn ">
                      ...
                      <a href="#" onclick="eximForm()" class="btn btn-sm btn-secondary" title="Importar Lista" data-toggle="modal"><i class="mdi mdi-upload icon-btn"></i></a>
                      @endif
                              ...
                              <td nowrap="">
                                ...
                                <td>
                                  @if(@isset($permisos['editar']['permiso']) and  $permisos['editar']['permiso'] == 1)
                                    <a href="{{route('leads.edit', ['id'=>$datos->id,'tipo'=>2])}}"> 
                                    {{ $datos->dni_doc }}</a>
                                  @else
                                    {{ $datos->dni_doc }}
                                  @endif
                                ...
                                <td class="text-center">{{ $datos->dtrack }}</td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <input type="hidden" id="tipo_evento" value="{{session('evento_tipo')}}">
      </div>
      </form>
    </div>
  </div>
