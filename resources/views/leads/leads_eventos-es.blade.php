          ...
          <div class="card">
            <div class="card-body">
              <div class="d-flex justify-content-between align-items-center">
                <h4 class="card-title">Leads / Registros aa

                  @if(!session('evento')['maestria'])
                  {{-- eventos.index --}}
                  <a class="btn btn-link" href="{{ route('eventos-es.index') }}"><i class="mdi text-link mdi-keyboard-backspace"></i> Volver eventos</a>
                  @else
                  <a class="btn btn-link" href="{{ route('eventos-es.index') }}"><i class="mdi text-link mdi-keyboard-backspace"></i> Volver</a>
                  @endif
                </h4>
                    ...
                    <div class="col-xs-12  col-sm-8 text-left mb-4">
                      ...
                      <div class="btn-group" role="group">
                          ...
                          <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                            <a class="dropdown-item" href="{{route('reportes.e_registrados')}}?t=7">Registrados</a>
                          </div>
                      </div>
                      @endif
                        ...
                        <table id="order-listing" class="table table-hover table-sm">
                          <thead class="thead-dark">
                            <tr role="row">
                              ...
                              <th style="width: 5%;">Temática</th>
                              <th style="width: 10%;">Pregunta</th>
                              <th style="width: 10%;">Autorizo Email</th>
                          ...
                          <tbody>
                            ...
                            <tr role="row" class="odd" <?php if($datos->dtrack == "SI") echo "style='background:#a0e8c5;'"?> <?php if($datos->dtrack == "NO") echo "style='background:#f7d3d3;'"?>>
                              <td><input type="checkbox" class="form btn-delete" name="tipo_doc[]" value="{{ $datos->id }}" data-id="{{ $datos->id }}"></td>
                                ...
                                <td>{{ $datos->nombres }}</td>
                                <td>{{ \Illuminate\Support\Str::limit($datos->ap_paterno .' '. $datos->ap_materno, 60)  }}</td>
                                <td> {{ $datos->region, '' }} </td>
                                <td> {{ $datos->provincia or '' }} </td>
                                <td> {{ $datos->distrito or '' }} </td>
                                <td> {{ $datos->email }}</td>
                                <td> {{ \Illuminate\Support\Str::limit($datos->dgrupo,50) }}</td>
                                <td> {{ $datos->pregunta or '' }} </td>
                                <td>
                                  @if($datos->confirmado === 1)<span class="badge badge-dark">SI</span>@endif
                                </td>
