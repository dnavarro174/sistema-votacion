          ...
          <div class="container">
            <div class="row justify-content-center">{{-- $datos->activo == 2 --}}
              <div class="col-xs-12 col-md-10 col-lg-10 mt-3">
                <form class="forms-sample border-top shadow " id="ddjjForm" action="{{ route('dj_link.store') }}" method="post" enctype="multipart/form-data" autocomplete="on" >
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-12 col-md-3">
                              <div class="form-group">
                                <label for="tipo_ins">Tipo de Inscripción <span class="text-danger">*</span></label>
                                <select class="form-control dynamic_tipo" required name="tipo_ins" id="tipo_ins2">
                                  <option value="">SELECCIONE</option>
                                  @foreach($modalidad as $mod)
                                    @if(isset($_GET['t']))
                                    <option {{ $datos_reg->curso->modalidad==$mod->modalidad? 'selected' : ''}} value="{{$mod->modalidad}}">{{$mod->modalidad}}</option>
                                    @else
                                    <option {{ $mod->modalidad==old('tipo_ins')? 'selected' : ''}} value="{{$mod->modalidad}}">{{$mod->modalidad}}</option>                                  
                                    @endif
                                  @endforeach
                                  {{-- falta jalar los datos segun el ID TB. M4_CURSOS
                            ...
                            <div class="col-sm-12 col-md-3">
                              <div class="form-group">
                                ...
                                <input type="hidden" name="tpo" value="1">
                              </div>
                            </div>
                            @endif
                          ...
                          <div class="row">
                            ...
                            <div class="col-sm-12 col-md-4">
                              <div class="form-group ">
                                ...
                                <select style="width:100%;" class="form-control text-uppercase" required name="moda_contractual" id="moda_contractual" class="codigo_cel" required>
                                  ...
                                  <option value="OTROS" {{"OTROS"==$datos_reg->moda_contractual?'selected':''}}>OTROS</option>
                                  @else
                                  ...
                                  <option value="OTROS" {{"OTROS"==old('moda_contractual')?'selected':''}}>OTROS</option>
                                  @endif
                                </select>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-11 col-md-11">
                              <div class="form-group text-justify border-top pt-4 pl-4">
                                ...
                                <p class="mb-0">
                                  {{-- ● Si se detecta una DJ conteniendo información falsa será notificada a las autoridades competentes.SSS<br>
                                  ● Al postular a una beca en la ENC, usted está declarando haber leído las condiciones del participante (SIGE) y los <a href="https://enc-ticketing.org/comunicaciones/enconocimiento/academico/requisitos.pdf" target="_blank">requisitos para postular</a> a la beca. <br>
                                  ● Antes de marcar la opción enviar, verifique los datos registrados en la declaración jurada. Una vez que postule 
                                  a la beca no podrá realizar ningún cambio. --}}

                                  ● Si se detecta un documento conteniendo información falsa será notificad@ a las autoridades competentes.<br>
                                  ● Si envía el documento usted está aceptando su participación al curso o programa. <br>
                                  ● Antes de marcar la opción enviar, verifique los datos registrados en el documento.  <br>
                                  ● Al postular a una beca en la ENC, usted está declarando haber leído las condiciones del participante en el SIGE y los <a href="https://enc-ticketing.org/comunicaciones/enconocimiento/ACADEMICO/requisitos.pdf" target="_blank">requisitos para postular</a> a la beca.
