...
<head>
<meta charset="utf-8">
<title>Términos y Condiciones - Newsletter</title>
</head>
<body>
        ...
        <tbody>
          <tr>
            ...
            <td width="540">
              ...
              La Escuela Nacional de Control le informa que ha entrado en vigencia el Decreto Legislativo 1390. En ese sentido, para seguir informándole acerca de nuestros servicios educativos, requerimos de su consentimiento para enviarle email a su correo electronico: <br>
                <br>

              <form class="forms-sample form-control" id="graciasN" action="{{ route('estudiantes.gracias') }}" method="post">
                {!! csrf_field() !!}
                <div class="row">
                    <div class="col-sm-12 form-group">
                      

                      <label class=" col-form-label"><input type="radio" class="form btn-html" name="termino" value="SI" data-xid="SI"> Si acepto los terminos y condiciones</label>
                      <br>
                      <label class=" col-form-label"><input type="radio" class="form btn-html" name="termino" value="NO" data-xid="NO"> No acepto los terminos y condiciones</label>
                      <p>
                        <input type="hidden" name="cid" value="{{ $id_estudiantes }}">
                      </p>
                        
                      <button type="submit" id="EnviarNewsletter">Enviar</button>
