                          ...
                          <div class="row">
                              ...
                              <div class="col-xs-12 col-md-2 text-right">
                                  <div class="form-group ">
                                      <input type="text" class="form-control" id="fecha_req" name="fecha_req" aria-describedby="" placeholder="" value="{{ old('fecha_req', date('d/m/Y')) }}">
                                  </div>
                              </div>
                          </div>
                          <div class="row">
                              ...
                              <div class="col-xs-12 col-md-2">
                                  <div class="form-group ">
                                      <input type="text" class="form-control" id="numeror" name="numeror" aria-describedby="" placeholder="" value="{{ old('inputApe_pat', $num) }}">
                                  </div>
                              </div>
                          </div>
                          <div class="row">
