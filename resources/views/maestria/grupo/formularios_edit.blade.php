            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample pr-4 pl-4" id="caiieventosForm" action="{{ route('grupo-maestria_form.update', $datos->eventos_id) }}" method="post" enctype="multipart/form-data" >
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="ubigeo" @if($datos->ubigeo == 1) checked="" @endif type="checkbox" class="form-check-input" value="1"> Ubigeo <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="fecha_nac" @if($datos->fecha_nac == 1) checked="" @endif type="checkbox" class="form-check-input" value="1"> Fecha Nacimiento <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="sexo" @if($datos->sexo == 1) checked="" @endif type="checkbox" class="form-check-input" value="1"> Género <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-4">
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="email_labor2" @if($datos->email_labor2 == 1) checked="" @endif type="checkbox" class="form-check-input" value="1"> Email Alternativo <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="si_cgr" @if($datos->si_cgr == 1) checked="" @endif type="checkbox" class="form-check-input" value="1"> Trabajador CGR <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="codigo_cgr" @if($datos->codigo_cgr == 1) checked="" @endif type="checkbox" class="form-check-input" value="1"> Código Trabajador <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="form-group row">
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="discapacidad" type="checkbox" class="form-check-input" value="1" @if($datos->discapacidad == 1) checked="" @endif> Discapacidad <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="compago" type="checkbox" class="form-check-input" value="1" @if($datos->compago == 1) checked="" @endif> Comprobante <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="decjur" type="checkbox" class="form-check-input" value="1" @if($datos->decjur == 1) checked="" @endif> Declaraciones Juradas <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="ficins" type="checkbox" class="form-check-input" value="1" @if($datos->ficins == 1) checked="" @endif> Ficha de Inscripción <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="cv" type="checkbox" class="form-check-input" value="1" @if($datos->cv == 1) checked="" @endif> Curriculum Vitae <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="foto" type="checkbox" class="form-check-input" value="1" @if($datos->foto == 1) checked="" @endif> Foto <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="nvoucher" type="checkbox" class="form-check-input" value="1" @if($datos->nvoucher == 1) checked="" @endif> N° de Voucher <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-6">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="fechadepo" type="checkbox" class="form-check-input" value="1" @if($datos->fechadepo == 1) checked="" @endif> Fecha Depósito <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12 text-center mt-4">
                        ...
                        <a href="{{ route('grupo-maestria.index') }}" class="btn btn-light">Volver atrás</a>
                      </div>
