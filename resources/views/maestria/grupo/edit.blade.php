            ...
            <div class="col-md-9 grid-margin stretch-card">
              <div class="card mt-4">
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="estudiantesForm"  action="{{ route('grupo-maestria.update', $datos->id) }}" method="post"> 
                    {!! method_field('PUT') !!}
                    {!! csrf_field() !!}

                    <div class="form-group row">
                        <label for="nombre_evento" class="col-sm-2 col-form-label ">Periodo  <span class="text-danger">*</span></label>
                        <div class="col-sm-10">
                          <input type="text" required="" class="form-control" name="nombre_evento" placeholder="Nombre del Periodo *" value="{{ $datos->nombre_evento }}" />
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12 text-center mt-4">
                        ...
                        <a href="{{ route('grupo-maestria.index') }}" class="btn btn-light">Volver al listado</a>
                      </div>
