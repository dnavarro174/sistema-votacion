            ...
            <div class="col-md-8 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample pr-4 pl-4" id="caiieventosForm" action="{{ route('grupo-maestria_form.store') }}" method="post" enctype="multipart/form-data" >
                    {!! csrf_field() !!}
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="ubigeo" type="checkbox" class="form-check-input" value="1" checked> Ubigeo <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="sexo" type="checkbox" class="form-check-input" value="1" checked> Género <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="email_labor2" type="checkbox" class="form-check-input" value="1" checked> Email Alternativo<i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="si_cgr" type="checkbox" class="form-check-input" value="1" checked> Si Trabajador CGR<i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="codigo_cgr" type="checkbox" class="form-check-input" value="1" checked> Código Trabajador <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="form-group row">
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="discapacidad" type="checkbox" class="form-check-input" value="1" checked> Discapacidad <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="compago" type="checkbox" class="form-check-input" value="1" checked> Comprobante <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="decjur" type="checkbox" class="form-check-input" value="1" checked> Declaraciones Juradas <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="ficins" type="checkbox" class="form-check-input" value="1" checked> Ficha de Inscripción <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="cv" type="checkbox" class="form-check-input" value="1" checked> Curriculum Vitae <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="foto" type="checkbox" class="form-check-input" value="1" checked> Foto <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="form-group row">
                            <div class="col-sm-4">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="nvoucher" type="checkbox" class="form-check-input" value="1" checked> N° de Voucher <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
                            <div class="col-sm-6">
                              <div class="form-check">
                                <div class="col-sm-10 form-check form-check-flat">
                                  <label class="form-check-label">
                                    <input name="fechadepo" type="checkbox" class="form-check-input" value="1" checked> Fecha Depósito <i class="input-helper"></i></label>
                                </div>
                              </div>
                            </div>
