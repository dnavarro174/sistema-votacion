            ...
            <div class="col-md-9 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="card-title text-transform-none">Creación del Periodo</h4>
                
                  <form class="forms-sample pr-4 pl-4" id="caiieventosForm" action="{{ route('grupo-maestria.store') }}" method="post">
                    {!! csrf_field() !!}
                    
                      <div class="form-group row">
                        <label for="nombre_periodo" class="col-sm-2 col-form-label d-block">Periodo <span class="text-danger">*</span></label>
                        <div class="col-sm-10">
