                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="row">
                      <div class="col-sm-4 form-group">
                        ...
                        <select disabled class="form-control text-uppercase" required="" name="tipo_doc" id="tipo_doc">
                    ...
                    <div class="row">
                      <div class="col-sm-4 form-group">
                        ...
                        <input disabled type="text" required="" class="form-control text-uppercase" id="nombres" name="nombres" placeholder="Nombres / Name" value="{{ $estudiantes_datos->nombres }}">
                      ...
                      <div class="col-sm-4 form-group">
                        ...
                        <input disabled type="text" class="form-control text-uppercase" id="ap_paterno" name="ap_paterno" required="" placeholder="Apellido Paterno / Last Name" value="{{ $estudiantes_datos->ap_paterno }}">
                        {!! $errors->first('ap_paterno', '<span class=error>:message</span>') !!}
                        
                      </div>
                      <div class="col-sm-4 form-group">
                        <label class="col-form-label" for="ap_materno">Apellido Materno </label>
                        <input disabled type="text" class="form-control text-uppercase" id="ap_materno" name="ap_materno" placeholder="Apellido Materno" value="{{ $estudiantes_datos->ap_materno }}">
                    ...
                    <div id="cboPais" class="row cboPais">
                      ...
                      <div class="col-sm-4 form-group">
                        ...
                        <select disabled class="form-control text-uppercase" id="cboDepartamento" name="region">
                          <option value="">SELECCIONE</option>
                      ...
                      <div class="col-sm-4 form-group">
                        ...
                        <select disabled class="form-control text-uppercase" required="" id="area" name="area">
                          <option value="">SELECCIONE</option>
                          @foreach($areasenc as $a)
                            <option value="{{$country->name}}" @if ($a->id === $estudiantes_datos->region) 
                                selected 
                    ...
                    <div class="row">
                      <div class="col-sm-4 form-group">
                        ...
                        <input disabled type="text" class="form-control" id="emailenc" name="emailenc" required="" placeholder="Correo electrónico personal / Email" value="{{ $estudiantes_datos->email }}">
                      ...
                      <div class="col-sm-4 form-group">
                        ...
                        <input disabled type="text" class="form-control" id="email" name="email" required="" placeholder="Correo electrónico personal / Email" value="{{ $estudiantes_datos->email }}">
                        {!! $errors->first('email', '<span class=error>:message</span>') !!}
                      </div>

                      <div class="col-sm-4 form-group">
                        <label class="col-form-label" id="accedio">Correo Generado</label>
                        <select disabled class="form-control text-uppercase" name="accedio" id="accedio" required="">
                          <option value="">Seleccione</option>
                          <option value="SI" @if("SI"== $estudiantes_datos->estado) selected="" @endif>SI</option>
                          <option value="NO" @if("NO"== $estudiantes_datos->estado) selected="" @endif>NO</option>
                        </select>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-4 form-group">
                        ...
                        <select disabled class="form-control text-uppercase" name="estado" id="estado" required="">
                          <option value="">Seleccione</option>
