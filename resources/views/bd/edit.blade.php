            ...
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" id="estudiantesForm"  action="{{ route('bd.update', $estudiantes_datos->id) }}" method="post">
                    {!! method_field('PUT') !!}
                    {!! csrf_field() !!}
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-2 form-group">
                        ...
                        <input type="hidden" name="inputdni" value="{{ $estudiantes_datos->dni_doc }}">
                      </div>
                    ...
                    <div class="form-group row masinfo">
                      <div class="col-sm-12 text-center mt-4">
                        ...
                        <a href="{{ route('bd.index') }}" class="btn btn-light">Volver al listado</a>
