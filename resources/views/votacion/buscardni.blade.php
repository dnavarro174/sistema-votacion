...
@section('content')
  ...
  <div class="container-scroller bg_fondo2">
        ...
        <div class="row w-100">
          <div class="col-lg-8 mx-auto">            
            <div class="auto-form-wrapper wrapper_login bg-light">
              <p class="text-center">
                <img class="text-center img-fluid" src="{{URL::route('home')}}/images/form/a/logo_1764140086.png" width="180" alt="Logo" />
              </p>
                <h4 class="text-center pt-2 pb-1"><strong class="text-danger">Voto </strong> Escolar</h4>
                {{-- <h5>
                  {{'Evento: '. session('t') }}
                </h5> --}}
              <div class="col-lg-8 mx-auto">
                <form class="forms-sample" id="asistenciaForm" action="{{ route('votacion.elegir') }}" method="get">
                  {{-- {!! csrf_field() !!} --}}
                  ...
                  <div class="form-group text-center mt-4">
                    <button id="actionSubmit" value="Guardar" type="submit" class="btn btn-danger ">Elegir Candidato</button>
    ...
    <p class="footer-text text-center text-black pt-0">Copyright © 2025 <br>
              Desarrollado por:
              Linda Manayay  /  Dany Navarro 
            </p>
  </div>
      <!-- main-panel ends -->
...
$("#asistencia_dni").on("input", function(e) {
  ...
  if (val.length > 4) {
    ...
    let url = "https://ipresma.com/voto2025/public/consulta/"+val+"";
    console.log(url);
