...
#votacion
Route::get('votacion/{eventos_id?}', ['as'=>'votacion.index','uses'=>'App\Http\Controllers\VotacionController@index']);
Route::post('votacion', ['as'=>'votacion.store','uses'=>'App\Http\Controllers\VotacionController@store']);
Route::get('votacion_elegir', ['as'=>'votacion.elegir','uses'=>'App\Http\Controllers\VotacionController@elegir']);
Route::post('votacion/confirmar', ['as'=>'votacion.confirmar','uses'=>'App\Http\Controllers\VotacionController@confirmar_act']);
#Route::get('votacion_candidatos/{eventos_id?}', ['as'=>'votacion.index','uses'=>'App\Http\Controllers\VotacionController@index']);



Route::get('/consulta/{dni}', ['as'=>'consulta.validar_dni','uses'=>'App\Http\Controllers\VotacionController@validar_dni']);
//Route::get('asistencia/consultax/{dni}', ['as'=>'asistencia.validar_dni_x_hora','uses'=>'App\Http\Controllers\AsistenciaController@validar_dni_x_hora']);
