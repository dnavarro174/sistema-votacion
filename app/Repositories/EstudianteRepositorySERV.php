    ...
    function estudiante_import($data,$contF,$chkE_invitacion,$request){
        ...
        foreach ($data_exc as $lst) {
            ...
            if($flagPASAdni == 1){
                ...
                if(!($verEst)){
                    ...
                    if($chkE_invitacion == 1 AND $check_stado == 0){
                        ...
                        #dd($rs_datos,$from_email,$from_name,$from_name2);

                        // PRESENCIAL 
                        if($modalidad==1){
                            $asunto = $rs_datos->p_conf_inscripcion_asunto;
                            $msg_text = $rs_datos->p_conf_inscripcion;// plantila email
                            $msg_cel = $rs_datos->p_conf_inscripcion_2;//msg what
                        }else{
                            // VIRTUAL
                            $asunto = $rs_datos->p_conf_inscripcion_asunto_v;
                            $msg_text = $rs_datos->p_conf_inscripcion_v;// plantila email
                            $msg_cel = $rs_datos->p_conf_inscripcion_2_v;// msg what
                        }
                        $confirm_email = $rs_datos->p_conf_inscripcion_email;
                        $confirm_msg   = $rs_datos->p_conf_inscripcion_msg;
            ...
            if($flagPASA==1){
                ...
                #dd("paso 2 ",$rs_datos,$from_email,$from_name2);
                $confirm_email = $rs_datos->p_conf_inscripcion_email;
                $confirm_msg   = $rs_datos->p_conf_inscripcion_msg;
