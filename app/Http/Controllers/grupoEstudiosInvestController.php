...
class grupoEstudiosInvestController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if(!isset( session("permisosTotales")["einvestigacion"]["permisos"]["inicio"]   ) ){  
            Auth::logout();
        ...
        if(Cache::has('permisos.all')){
            ...
            $permParam["modulo_alias"] = "einvestigacion";
        ...
        $tipo_evento = 5; // tb_eventos_tipo: Tipo: 5 - Estudios de Invest.
        ...
        if($request->get('s')){
            ...
            $key = 'grupoestudio.page.'.request('page', 1);
        ...
        return view('estudioinv.index', compact('eventos_datos','permisos')); 
    ...
    public function create(Request $request)
    {
        ...
        //VERIFICA SI TIENE EL PERMISO
        if(!isset( session("permisosTotales")["einvestigacion"]["permisos"]["nuevo"]   ) ){  
            Auth::logout();
            return redirect('/login');
        }
        ...
        return view('estudioinv.create', compact('emails'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $f_ini_evento = $fechai_evento ." ".$h_ini;
        ...
        $ev = DB::table('eventos')->insert([
             ...
             'eventos_tipo_id'  => 5,// tb_eventos_tipo: Tipo: 4 - Maestría
        ...
        /*--plantillas */
            ...
            if($request->input('p_conf_registro') != ""){
                ...
                $file_2=fopen(resource_path().'/views/email/1p_conf_registro.blade.php','w') or die ("error creando fichero!");
        ...
        return redirect()->route('grupo-estudio-investigacion_form.create',compact('eventos_id'));
    ...
    public function edit($id)
    {
        $this->actualizarSesion();
        //VERIFICA SI TIENE EL PERMISO
        if(!isset( session("permisosTotales")["einvestigacion"]["permisos"]["editar"]   ) ){  
            Auth::logout();
            return redirect('/login');
        }
        ...
        return view('estudioinv.edit', compact('datos','emails'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::table('eventos')->where('id', $id)->update([
             ...
             'confirm_email'=> $confirm_email,
             'confirm_msg'  => $confirm_msg,
             'eventos_tipo_id'=> 5,// Tipo: 5 - Est. Inv
             'updated_at'   => Carbon::now()
        ]);
    ...
    public function eliminarVarios(Request $request){
        ...
        $this->actualizarSesion();
        //VERIFICA SI TIENE EL PERMISO
        if(!isset( session("permisosTotales")["einvestigacion"]["permisos"]["eliminar"]   ) ){  
            Auth::logout();
            return redirect('/login');
        }
        ...
        foreach ($tipo_doc as $value) {
            ...
            Evento::where('id',$value)->where('eventos_tipo_id',5)->delete();
            Cache::flush();
    ...
    public function destroy($id)
    {
        ...
        Evento::where('id', $id)->where('eventos_tipo_id',5)->delete();
    ...
    public function createForm(Request $request){
        ...
        return view('estudioinv.formularios',compact('eventos_id'));
    }
    ...
    public function editForm($id)
    {
        ...
        return view('estudioinv.formularios_edit', compact('datos'));
    }
