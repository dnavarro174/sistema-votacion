...
class MaestriasController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        if($request->get('s')){
            ...
            $key = 'formato_maestria.page.'.request('page', 1);
    ...
    public function create()
    {
        ...
        $num = Maestria::select('numeror')->orderBy('id','DESC')->limit(1)->first();
        $num = $num->numeror;
        return view('maestria.create',compact('num'));
    }
    ...
    public function store(Request $request)
    {
        ...
        //try {
            ...
            if($check){
                alert()->warning('Nº de Requeriemiento ya existe.','Mensaje')->persistent('Cerrar');
                return back();
