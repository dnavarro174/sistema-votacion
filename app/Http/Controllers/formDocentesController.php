...
class formDocentesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if(!isset( session("permisosTotales")["formdoc"]["permisos"]["inicio"]   ) ){  
            Auth::logout();
        ...
        if(Cache::has('permisos.all2')){
            ...
            $permParam["modulo_alias"] = "formdoc";
        ...
        $tipo_evento = 9; // tb:eventos_tipo: Tipo: 9 - Form Docentes
        ...
        if($request->get('s')){
            ...
            $key = 'formdoc.page.'.request('page', 1);
        ...
        return view('docentes.grupo.index', compact('eventos_datos','permisos')); 
    ...
    public function create(Request $request)
    {
        ...
        //VERIFICA SI TIENE EL PERMISO
        if(!isset( session("permisosTotales")["formdoc"]["permisos"]["nuevo"]   ) ){  
            Auth::logout();
            return redirect('/login');
        }

        $emails = Emails::orderBy("nombre",'asc')->where('id',4)->get();
        
        return view('docentes.grupo.create', compact('emails'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $ev = DB::table('eventos')->insert([
             ...
             'eventos_tipo_id'  => 9,// tb_eventos_tipo: Tipo: 9 - Form Docentes
        ...
        return redirect()->route('grupo-doc_form.create',compact('eventos_id'));
    }
    ...
    public function createForm(Request $request){
        ...
        if(isset($request->eventos_id)){
            ...
            return redirect()->route('grupo-doc.index');
        }
       
        return view('docentes.grupo.formularios',compact('eventos_id'));
    }
        ...
        try {
            ...
            if($request->file('img_cabecera') && $request->file('img_footer')){
                ...
                DB::table('e_formularios')->insert([
                    ...
                    'email_labor2'  =>$request->input('email_labor2'),
                    ...
                    'codigo_cgr'    =>$request->input('codigo_cgr'),
                    ...
                    'opc_3'         =>$request->input('opc_3'),
                    'opc_4'         =>$request->input('opc_4'),
                    'opc_5'         =>$request->input('opc_5'),
                    'opc_6'         =>$request->input('opc_6'),
                    'opc_7'         =>$request->input('opc_7'),
                    'opc_8'         =>$request->input('opc_8'),
                ]);
    ...
    public function editForm($id)
    {
        $this->actualizarSesion();
        //VERIFICA SI TIENE EL PERMISO
        if(!isset( session("permisosTotales")["formdoc"]["permisos"]["editar"]   ) ){  
            Auth::logout();
            return redirect('/login');
        }
        ...
        return view('docentes.grupo.formularios_edit', compact('datos'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('docentes.grupo.edit', compact('datos', 'emails'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::table('eventos')->where('id', $id)->update([
             ...
             'confirm_email'=> $confirm_email,
             'confirm_msg'  => $confirm_msg,
             'eventos_tipo_id'=> 9,// tb_eventos_tipo: Tipo: 9 - Form Doc
             'updated_at'   => Carbon::now()
        ]);
    ...
    public function eliminarVarios(Request $request){
        ...
        $this->actualizarSesion();
        //VERIFICA SI TIENE EL PERMISO
        if(!isset( session("permisosTotales")["formdoc"]["permisos"]["eliminar"]   ) ){  
            Auth::logout();
            return redirect('/login');
        }
        ...
        foreach ($tipo_doc as $value) {
            ...
            Evento::where('id',$value)->where('eventos_tipo_id',9)->delete();
            Cache::flush();
    ...
    public function destroy($id)
    {
        ...
        Evento::where('id', $id)->where('eventos_tipo_id',9)->delete();
