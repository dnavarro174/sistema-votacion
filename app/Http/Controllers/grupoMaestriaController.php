...
class grupoMaestriaController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $tipo_evento = 4; // tb_eventos_tipo: Tipo: 4 - Maestria
        ...
        return view('maestria.grupo.index', compact('eventos_datos','permisos')); 
    ...
    public function create(Request $request)
    {
        ...
        return view('maestria.grupo.create', compact('emails'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $ev = DB::table('eventos')->insert([
             ...
             'eventos_tipo_id'  => 4,// tb_eventos_tipo: Tipo: 4 - Maestría
        ...
        return redirect()->route('grupo-maestria_form.create',compact('eventos_id'));
    }
    ...
    public function createForm(Request $request){
        ...
        return view('maestria.grupo.formularios',compact('eventos_id'));
    }
    ...
    public function editForm($id)
    {
        ...
        return view('maestria.grupo.formularios_edit', compact('datos'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('maestria.grupo.edit', compact('datos', 'emails'));
    }
    ...
    public function eliminarVarios(Request $request){
        ...
        foreach ($tipo_doc as $value) {
            ...
            Evento::where('id',$value)->where('eventos_tipo_id',4)->delete();
            Cache::flush();
    ...
    public function destroy($id)
    {
        ...
        Evento::where('id', $id)->where('eventos_tipo_id',4)->delete();
