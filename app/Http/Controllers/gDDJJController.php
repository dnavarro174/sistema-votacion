...
class gDDJJController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $tipo_evento = 8; // tb:eventos_tipo: Tipo: 8 - Formulario DDJJ
        ...
        return view('ddjj.grupo.index', compact('eventos_datos','permisos')); 
    ...
    public function create(Request $request)
    {
        ...
        return view('ddjj.grupo.create', compact('emails'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $cod_grupo = "DJ.OCI_".$cod_grupo;

        //$path = public_path()."/storage/ddjj/$cod_grupo";
        #$path = public_path("/storage/ddjj/").$cod_grupo;
        $path = "storage/ddjj/".$cod_grupo;
        if (!file_exists($path)) {
        ...
        $ev = DB::table('eventos')->insert([
             ...
             'eventos_tipo_id'  => 8,// tb:eventos_tipo: Tipo: Formulario DDJJ
        ...
        return redirect()->route('grupo-dj_form.create',compact('eventos_id'));
    }
    ...
    public function createForm(Request $request){
        ...
        return view('ddjj.grupo.formularios',compact('eventos_id'));
    }
    ...
    public function editForm($id)
    {
        ...
        return view('ddjj.grupo.formularios_edit', compact('datos'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('ddjj.grupo.edit', compact('datos', 'emails'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        DB::table('eventos')->where('id', $id)->update([
             ...
             'confirm_email'=> $confirm_email,
             'confirm_msg'  => $confirm_msg,
             'eventos_tipo_id'=> 8,// tb:eventos_tipo: Tipo: 8 - Formulario DDJJ
             'updated_at'   => Carbon::now()
        ]);
    ...
    public function eliminarVarios(Request $request){
        ...
        foreach ($tipo_doc as $value) {
            ...
            Evento::where('id',$value)->where('eventos_tipo_id',8)->delete();
            Cache::flush();
    ...
    public function destroy($id)
    {
        ...
        Evento::where('id', $id)->where('eventos_tipo_id',8)->delete();
